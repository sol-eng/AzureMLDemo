...
automl_run_id = 'cool_leg_8gv3wntnmq_3'
...
def generate_data_transformation_config():
    ...
    column_group_1 = ['Area Code', 'VMail Message', 'Day Calls', 'Eve Calls', 'Night Calls', 'Intl Calls', 'CustServ Calls']
    
    column_group_0 = [['Account Length'], ['Day Mins'], ['Eve Mins'], ['Night Mins'], ['Intl Mins']]
    
    column_group_2 = ['intlplan', 'VMail plan', 'AK', 'AL', 'AR', 'AZ', 'CA', 'CO', 'CT', 'DC', 'DE', 'FL', 'GA', 'HI', 'IA', 'ID', 'IL', 'IN', 'KS', 'KY', 'LA', 'MA', 'MD', 'ME', 'MI', 'MN', 'MO', 'MS', 'MT', 'NC', 'ND', 'NE', 'NH', 'NJ', 'NM', 'NV', 'NY', 'OH', 'OK', 'OR', 'PA', 'RI', 'SC', 'SD', 'TN', 'TX', 'UT', 'VA', 'VT', 'WA', 'WI', 'WV', 'WY']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://subscriptions/cdc5ba7c-38d0-43f9-9670-7b37680ad295/resourcegroups/sol-eng/workspaces/randre_azml_test_2/datastores/workspaceblobstore/paths/LocalUpload/ff83a20412a6c2cca54348d229447615/training-mltable-folder/',     help='Default training dataset uri is populated from the parent run')
